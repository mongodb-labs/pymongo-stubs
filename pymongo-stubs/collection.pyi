...
class Collection(common.BaseObject):
    ...
    def insert_one(
        self, document: Mapping[str, Any], bypass_document_validation: bool = ..., session: Optional[ClientSession] = ...
    ) -> InsertOneResult: ...
    def insert_many(
        self,
    ...
    def index_information(self, session: Optional[ClientSession] = ...) -> Mapping[str, Any]: ...
    def options(self, session: Optional[ClientSession] = ...) -> Mapping[str, Any]: ...
    ...
    def rename(self, new_name: str, session: Optional[ClientSession] = ..., **kwargs: Any) -> Mapping[str, Any]: ...
    def distinct(
    ...
    def map_reduce(
        ...
        session: Optional[ClientSession] = ...,
        **kwargs: Any,
    ) -> Union[Collection, Mapping[str, Any]]: ...
    ...
    def remove(self, spec_or_id: Any = ..., multi: bool = ..., **kwargs: Any) -> Optional[Mapping[str, Any]]: ...
    def find_and_modify(
        self,
