...
WriteOp = TypeVar("WriteOp", bound=Union[InsertOne, DeleteOne, DeleteMany, ReplaceOne, UpdateOne, UpdateMany], covariant=True)
...
class Collection(common.BaseObject):
    ...
    def aggregate_raw_batches(
        self, pipeline: _Pipeline, session: Optional[ClientSession] = ..., **kwargs: Any
    ) -> RawBatchCursor: ...
    def watch(
        self,
