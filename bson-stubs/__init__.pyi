import datetime
from typing import Any, BinaryIO, Iterator, List, Mapping, MutableMapping, Type, TypeVar
...
def encode(document: Mapping[str, Any], check_keys: bool = ..., codec_options: CodecOptions = ...) -> bytes: ...
def decode(data: bytes, codec_options: CodecOptions = ...) -> Mapping[str, Any]: ...
def decode_all(data: bytes, codec_options: CodecOptions = ...) -> List[Mapping[str, Any]]: ...
def decode_iter(data: bytes, codec_options: CodecOptions = ...) -> Iterator[Mapping[str, Any]]: ...
...
class BSON(bytes):
    @classmethod
    def encode(
        cls: Type[_BSON], document: Mapping[str, Any], check_keys: bool = ..., codec_options: CodecOptions = ...
    ) -> _BSON: ...
    # TODO: error: Signature of "update" incompatible with supertype "bytes"
    def decode(self, codec_options: CodecOptions = ...) -> MutableMapping[str, Any]: ...  # type: ignore[override]
