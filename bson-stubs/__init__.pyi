import datetime
from typing import Any, BinaryIO, ByteString, Iterator, List, Mapping, MutableMapping, Optional
...
class BSON(bytes):
    @classmethod
    def encode(cls, document: Mapping[str, Any], check_keys: bool = ..., codec_options: CodecOptions = ...) -> BSON: ...
