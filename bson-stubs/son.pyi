...
class SON(Dict[_Key, _Value]):
    ...
    def keys(self) -> List[_Key]: ...  # type: ignore
    ...
    def update(self, other: Optional[Any] = ..., **kwargs: _Value) -> None: ...  # type: ignore
